...
export declare class TokenBridgeContract extends ContractBase {
    ...
    methods: {
        ...
        /** exit_to_l1_public(recipient: struct, amount: field, nonce: field) */
        exit_to_l1_public: ((recipient: EthAddressLike, amount: FieldLike, nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
