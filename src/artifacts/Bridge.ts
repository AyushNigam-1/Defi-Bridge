...
import BridgeContractArtifactJson from '../../target/token_contract-Bridge.json' assert { type: 'json' };
export const BridgeContractArtifact = loadContractArtifact(BridgeContractArtifactJson as NoirCompiledContract);
...
export class BridgeContract extends ContractBase {
  ...
  private constructor(
    ...
    super(instance, BridgeContractArtifact, wallet);
  }
  ...
  public static deploy(wallet: Wallet, token: AztecAddressLike) {
    return new DeployMethod<BridgeContract>(Fr.ZERO, wallet, BridgeContractArtifact, BridgeContract.at, Array.from(arguments).slice(1));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
   */
  public static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, token: AztecAddressLike) {
    return new DeployMethod<BridgeContract>(publicKeysHash, wallet, BridgeContractArtifact, BridgeContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof BridgeContract['methods']>(
    opts: { publicKeysHash?: Fr; method?: M; wallet: Wallet },
    ...args: Parameters<BridgeContract['methods'][M]>
  ) {
    return new DeployMethod<BridgeContract>(
      opts.publicKeysHash ?? Fr.ZERO,
      opts.wallet,
      BridgeContractArtifact,
      BridgeContract.at,
...
TokenNote: {
  ...
  public static get events(): { TokenMinted: {decode: (payload: L1EventPayload | undefined) => TokenMinted | undefined, eventSelector: EventSelector, fieldNames: string[] }, TokenBurned: {decode: (payload: L1EventPayload | undefined) => TokenBurned | undefined, eventSelector: EventSelector, fieldNames: string[] } } {
    return {
      TokenMinted: {
